...
export const explicitTerms = [
  ...
  /(gaa?nd|gaand)\s*me?\s*(lund|lauda|laude|loda|lode|danda|dande)\b/i,
  /(suar|soo?ar|suwar|sooar|kutte?|kutte|gadhe?|gadha|ullu)\s*ki\s*jh?a+a?nt?\b/i,
  /(gaa?nd|gand)\s*me?\s*ke?e?da\b/i,
  ...
  /(suar|soo?ar|suwar|sooar|kutte?)\s*ke\s*(bacche|bache|bacha|aulaad)\b/i,
  /(gaa?nd|gaand)\s*faa?d(du|do|de)?\b/i,
  /saali\s*randi\b/i,
  /\b(mkc|bkc)\b/i,
